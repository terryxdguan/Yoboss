  ...
  return (
    <main className="min-h-screen bg-[#F6F3EE] text-[#2B2B2B]">
      <div className="flex min-h-screen">
        <aside className="hidden w-[92px] shrink-0 border-r border-[#E7DED2] bg-[#FFFFFF]/55 py-5 md:block">
            ...
            {[
              ...
              <div
                ...
                className={`flex h-11 w-11 items-center justify-center rounded-lg border ${
                  active
                    ? "border-[#B8D4F4] bg-[#FFFFFF] text-[#2B2B2B] shadow-[0_0_0_3px_rgba(124,45,232,0.18)]"
        ...
        <section className="min-w-0 flex-1">
          <header className="flex flex-col gap-3 border-b border-[#E7DED2] bg-[#FFFFFF]/70 px-4 py-4 md:flex-row md:items-center md:justify-between md:px-8">
            <div>
            ...
            <div className="flex items-center gap-3">
              <div className="hidden items-center gap-2 rounded-full border border-[#E7DED2] bg-[#FFFFFF] px-4 py-2 text-sm text-[#9B948B] lg:flex">
                <Search className="h-4 w-4" />
                Search tasks...
              </div>
              <button className="flex h-10 w-10 items-center justify-center rounded-full border border-[#E7DED2] bg-[#FFFFFF] text-[#6F6A64]">
          ...
          <div className="px-4 py-6 md:px-8">
            <section className="mb-5 rounded-lg border border-[#D7CABB] bg-[#FFFFFF] p-4 shadow-[0_8px_24px_rgba(43,43,43,0.04)]">
              <div className="mb-3">
              ...
              <div className="grid grid-cols-1 gap-3 xl:grid-cols-[minmax(320px,1fr)_150px_210px_160px_auto]">
                ...
                <button className="flex items-center justify-between rounded-lg border border-[#DDD3C7] bg-[#FFFFFF] px-3 py-2 text-left">
                  <span>
                ...
                <button className="flex items-center gap-2 rounded-lg border border-[#DDD3C7] bg-[#FFFFFF] px-3 py-2 text-left">
                  <CalendarDays className="h-4 w-4 text-[#7C2DE8]" />
                  <span>
                    <span className="block text-[11px] font-semibold uppercase tracking-[0.12em] text-[#9B948B]">
                      Deadline
                    </span>
                ...
                <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#7C2DE8] px-5 py-2.5 text-sm font-semibold text-white">
            ...
            <section className="min-w-0">
              <div className="mb-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#7C2DE8] px-3 py-2 text-sm font-semibold text-white">
                    <Plus className="h-4 w-4" />
                    Add category
                  </button>
                  <div className="flex rounded-lg border border-[#E7DED2] bg-[#F6F3EE] p-1">
                    <button className="rounded-md bg-[#FFFFFF] px-3 py-1.5 text-sm font-semibold text-[#2B2B2B] shadow-sm">
                      Pending 8
                    </button>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                {columns.map((column) => (
                  <div
                    key={column.name}
                    className="rounded-lg border border-[#E7DED2] bg-[#FFFFFF] p-3"
                  >
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex min-w-0 items-center gap-2">
                          <button
                            ...
                            className="flex h-6 w-6 shrink-0 cursor-grab items-center justify-center rounded-md text-[#9B948B] hover:bg-[#FFFFFF]"
                          >
                    ...
                    <div className="mt-3 space-y-2">
                      {column.tasks.map((task) => (
                        <div
                          key={task.title}
                          className="rounded-lg border border-[#E7DED2] bg-[#FFFFFF] p-3 shadow-[0_2px_8px_rgba(43,43,43,0.03)]"
                        >
                          ...
                          <div className="mt-3 flex items-center justify-between">
                            <span className="rounded-full bg-[#F3ECFB] px-2 py-0.5 text-[11px] font-semibold text-[#5E8FCE]">
                              {task.badge}
                            </span>
