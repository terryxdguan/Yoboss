...
export function DashboardTeam() {
  ...
  return (
    <div className="rounded-2xl border border-[#E7DED2] bg-[#FFFFFF] p-6 shadow-[0_4px_16px_rgba(30,34,39,0.04)]">
      ...
      {team.length === 0 ? (
        <div className="rounded-[18px] border border-dashed border-[#E7DED2] bg-[#FFFFFF] p-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {team.map((agent) => (
            <div
              ...
              className="rounded-[18px] border border-[#E7DED2] bg-[#FFFFFF] p-5 shadow-[0_4px_16px_rgba(43,43,43,0.04)] hover:shadow-[0_10px_28px_rgba(43,43,43,0.08)] hover:border-[#DDD3C7] transition-all cursor-pointer"
            >
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-12 h-12 rounded-full overflow-hidden bg-[#F6F3EE] shrink-0">
                  <Image
