...
const BOTTOM: Tile[] = [
  { ext: "DOC", color: "#5E8FCE", bg: "#F3ECFB" },
...
function TileCard({ tile }: { tile: Tile }) {
  return (
    <div className="flex w-16 flex-col items-center gap-1 rounded-md border border-[#E7DED2] bg-[#FFFFFF] px-1.5 py-2">
      <div
...
export function DeliverablesIllustration() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-xl bg-[#FFFFFF] px-2 py-3">
