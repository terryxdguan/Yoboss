  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#E7DED2] bg-[#FFFFFF] text-[#2B2B2B] shadow-[0_2px_8px_rgba(0,0,0,0.10)] transition-colors hover:bg-[#F6F3EE]"
      ...
      {open && (
        ...
        >
          <div
            role="dialog"
            aria-label={t("title")}
            className="w-full max-w-md rounded-xl border border-[#E7DED2] bg-[#FFFFFF] p-6 shadow-xl"
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                ...
                onClick={handleClose}
                disabled={submitting}
                className="rounded-md p-1 text-[#6F6A64] hover:bg-[#F6F3EE] disabled:opacity-50"
                aria-label={t("close")}
              >
                <X className="h-4 w-4" />
              </button>
            ...
            {sent ? (
              <div className="mt-6 text-center">
                ...
                <button
                  type="button"
                  onClick={handleClose}
                  className="mt-5 rounded-lg border border-[#E7DED2] px-4 py-1.5 text-xs font-semibold text-[#2B2B2B] transition-colors hover:bg-[#F6F3EE]"
                >
                  {t("done")}
                </button>
              </div>
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center gap-1 rounded-lg border px-2 py-2.5 text-[11px] font-medium transition-colors ${
                          active
                            ...
                            : "border-[#E7DED2] text-[#2B2B2B] hover:bg-[#F6F3EE]"
                        }`}
                      >
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      onClick={handleClose}
                      disabled={submitting}
                      className="rounded-lg border border-[#E7DED2] px-3.5 py-1.5 text-xs font-semibold text-[#2B2B2B] transition-colors hover:bg-[#F6F3EE] disabled:opacity-50"
                    >
                      {t("cancel")}
                    </button>
                    <button
