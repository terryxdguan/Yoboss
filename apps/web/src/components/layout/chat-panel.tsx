    ...
    <>
      ...
      >
        <div className="flex items-center justify-between h-14 px-4 border-b border-[#E6E1D8]">
          <span className="text-sm font-medium text-[#1E2227]">
            YoBoss Coach
          </span>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
          <div className="max-w-[85%]">
            <div className="bg-[#F1EEE8] rounded-md px-3 py-2.5">
              <p className="text-sm leading-relaxed text-[#1E2227]">
        ...
        <div className="border-t border-[#E6E1D8] px-4 py-3">
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 text-sm bg-transparent outline-none placeholder:text-[#8C939B] text-[#1E2227]"
              onKeyDown={(e) => {
            ...
            />
            <button
              className="p-1.5 text-[#4C7CF0] hover:text-[#3F6FE4] transition-colors"
