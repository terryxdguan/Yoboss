...
export function TopicInputModal({ templateName, placeholder, onSubmit, onClose }: TopicInputModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#FFFFFF] rounded-2xl shadow-[0_24px_64px_rgba(43,43,43,0.15)] w-full max-w-lg overflow-hidden">
        {/* Header */}
        ...
        <div className="px-6 pb-6">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 text-sm bg-[#FFFFFF] border border-[#DDD3C7] rounded-xl text-[#2B2B2B] placeholder:text-[#9B948B] outline-none focus:ring-2 focus:ring-[#7C2DE8]/30 focus:border-[#7C2DE8] resize-none leading-relaxed"
          />
          <p className="text-[10px] text-[#9B948B] mt-1">
            Press <kbd className="px-1 py-0.5 rounded bg-[#F6F3EE] text-[#6F6A64] font-mono text-[9px]">Tab</kbd> to use the example topic. It will be injected into each step for this run only.
          </p>
          ...
          <div className="mt-4">
            <button
              ...
              disabled={!topic.trim()}
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#7C2DE8] text-white text-sm font-medium hover:bg-[#6921C7] transition-colors disabled:opacity-40"
            >
