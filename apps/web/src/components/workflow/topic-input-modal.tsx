    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#FFFDF9] rounded-2xl shadow-[0_24px_64px_rgba(43,43,43,0.15)] w-full max-w-lg overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-3">
          <div>
            <h2 className="text-lg font-semibold text-[#2B2B2B]">Enter Topic</h2>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="mt-4">
            <button
              ...
              disabled={!topic.trim()}
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#7FAEE6] text-white text-sm font-medium hover:bg-[#6A9DDA] transition-colors disabled:opacity-40"
            >
